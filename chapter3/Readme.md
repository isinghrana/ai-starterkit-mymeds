...
The following diagram highlights Azure Function which will be added to the solution in this chatper, you will start setting up the function but it won't be usable yet. Code Deployment to make the Azure Function operational will be added in the next chapter.
